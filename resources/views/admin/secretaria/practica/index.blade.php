        ...
        <form action="" method="GET">
            <div class="row my-4 gap-4">
                <div class="col-2">
                    ...
                    <select id="porfecha" name="porfecha" wire:model='porfecha' class="form-control form-select w-full"
                ...
                <div class="col-2">
                    ...
                    <select id="pordetalle" name="pordetalle" wire:model='pordetalle'
                        class="form-control form-select w-full" aria-label="Default select example">
                ...
                <div class="col-3">
                    ...
                    <input type="search" placeholder="Busqueda por Alumno" id="poralumno" name="poralumno"
                        class="w-full form-control" aria-label="search" value="{{$poralumno}}">
                ...
                <div class="col-3">
                    ...
                    <input type="search" placeholder="Busqueda por Docente" id="pordocente" name="pordocente"
                        class="w-full form-control" aria-label="search" value="{{$pordocente}}">
                    <small id="emailHelp" class="form-text text-muted">Filtro docente.</small>
    
                </div>
                <div class="col-2">
                    <div style="margin-top: 31px"><button type="submit" class="btn btn-success ml-2"><i
                                class="fas fa-search"></i></button></div>
                </div>
                <div class="col-12">
                    {{--ELIMINAR FILTROS--}}
                    <a class="btn btn-danger mt-4" href="{{route('admin.secretaria.practicas')}}" role="button">ELIMINAR
                        FILTROS</a>
                </div>
            </div>
        </form>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>
                            @if ($orden=='asc')
                            <a
                                href="{{url('admin/secretaria/practicas?porfecha='.$porfecha.'&pordetalle='.$pordetalle.'&poralumno='.$poralumno.'&pordocente='.$pordocente.'&filtro=created_at&orden=desc')}}"><i
                                    class="fas fa-angle-down"></i></a>
                            @else
                            <a
                                href="{{url('admin/secretaria/practicas?porfecha='.$porfecha.'&pordetalle='.$pordetalle.'&poralumno='.$poralumno.'&pordocente='.$pordocente.'&filtro=created_at&orden=asc')}}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('admin.secretaria.practica.revision',$practica->id)}}"
