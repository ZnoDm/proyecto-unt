...
return [
    ...
    */
    ...
    'logo_img' => 'img/recursos/logo_unt.png',
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'MANTENEDOR DE SECRETARIA',
            'can' => 'Ver Secretaria Practicas'
        ],
        [
            'text' => 'Bandeja Practicas',
            'active'      => ['admin/secretaria/practica*'],
        ...
        [
            'text' => 'Bandeja Solicitudes',
            'active'      => ['admin/direccion*'],
